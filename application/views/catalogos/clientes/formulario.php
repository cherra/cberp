<?php echo form_open($action, array('class' => 'form-horizontal', 'name' => 'form', 'id' => 'form', 'role' => 'form')) ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-md-6 col-lg-4">
            <input type="email" name="email" class="form-control" value="<?php echo (isset($datos->email) ? $datos->email : ''); ?>" placeholder="E-mail">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-sm-2" for="metodoDePago">Método de pago</label>
        <div class="col-sm-8 col-md-6 col-lg-4">
    ...
    <div class="form-group">
        <label class="col-sm-2" for="NumCtaPago">Número de cuenta</label>
        <div class="col-sm-8 col-md-6 col-lg-4">
            <input type="text" name="NumCtaPago" class="form-control" value="<?php echo (isset($datos->NumCtaPago) ? $datos->NumCtaPago : ''); ?>" placeholder="Número de cuenta">
        </div>
    </div>
<?php echo form_close(); ?>
