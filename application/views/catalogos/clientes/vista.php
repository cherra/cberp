...
<?php echo form_open($action, array('class' => 'form-horizontal', 'name' => 'form', 'id' => 'form', 'role' => 'form')) ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8 col-md-6 col-lg-4">
            <p class="form-control-static"><?php echo (isset($datos->metodoDePago) ? $datos->metodoDePago : ''); ?></p>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2" for="NumCtaPago">Número de cuenta</label>
        <div class="col-sm-8 col-md-6 col-lg-4">
            <p class="form-control-static"><?php echo (isset($datos->NumCtaPago) ? $datos->NumCtaPago : ''); ?></p>
        </div>
    </div>
<?php echo form_close(); ?>
